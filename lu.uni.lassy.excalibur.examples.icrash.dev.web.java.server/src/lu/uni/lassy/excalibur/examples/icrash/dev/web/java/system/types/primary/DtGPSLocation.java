...
public class DtGPSLocation implements Serializable, JIntIs {
		 ...
		 * @param aLongitude The datatype of longitude to assign to the GPS location
		 */
		...
		/* (non-Javadoc)
		 * @see lu.uni.lassy.excalibur.examples.icrash.dev.web.java.system.types.design.DtIs#is()
		 */
		public PtBoolean is(){
		...
		/* (non-Javadoc)
		 * @see lu.uni.lassy.excalibur.examples.icrash.dev.web.java.system.types.design.DtIs#getExpectedDataStructure()
		 */
		public PtString getExpectedDataStructure(){
			return new PtString("Expected structure of the GPS consisits of:\n" + this.latitude.getExpectedDataStructure().getValue() + "\n" + this.longitude.getExpectedDataStructure().getValue()); 
		}
}